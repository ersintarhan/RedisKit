...
namespace RedisLib.Serialization
{
    ...
    public static class RedisSerializerFactory
    {
        ...
        public static IRedisSerializer Create(RedisLib.Models.SerializerType serializerType, ILoggerFactory? loggerFactory = null)
        {
        ...
        public static IRedisSerializer Create<TOptions>(
            RedisLib.Models.SerializerType serializerType,
            TOptions options,
            ILoggerFactory? loggerFactory = null) where TOptions : class
        {
            ...
            return _serializerCache.GetOrAdd(cacheKey, key =>
            {
                ...
                {
                    (RedisLib.Models.SerializerType.MessagePack, MessagePack.MessagePackSerializerOptions messagePackOptions) =>
                        new MessagePackRedisSerializer(
                            loggerFactory?.CreateLogger<MessagePackRedisSerializer>(),
                            messagePackOptions),
                    
                    (RedisLib.Models.SerializerType.SystemTextJson, System.Text.Json.JsonSerializerOptions jsonOptions) =>
                        new SystemTextJsonRedisSerializer(
                            loggerFactory?.CreateLogger<SystemTextJsonRedisSerializer>(),
                            jsonOptions),
                    
                    (RedisLib.Models.SerializerType.MessagePack, _) =>
                    ...
                    (RedisLib.Models.SerializerType.SystemTextJson, _) =>
                    ...
                    (RedisLib.Models.SerializerType.Custom, _) =>
            ...
            ILoggerFactory? loggerFactory = null)
        {
            ...
            return _serializerCache.GetOrAdd(cacheKey, key =>
            {
                ...
                if (serializerType == RedisLib.Models.SerializerType.MessagePack)
                {
                ...
                else if (serializerType == RedisLib.Models.SerializerType.SystemTextJson)
                {
                ...
                else if (serializerType == RedisLib.Models.SerializerType.Custom)
                {
                    throw new ArgumentException("Custom serializer type requires using CreateCustom method", nameof(serializerType));
                }
                else
