...
public class SerializerTests
{
    ...
    {
        // Act
        var serializer = RedisSerializerFactory.Create(SerializerType.MessagePack);
    ...
    {
        // Act
        var serializer = RedisSerializerFactory.Create(SerializerType.SystemTextJson);
    ...
    public void SerializerFactory_Create_WithJsonOptions_PassesOptionsToSerializer()
    {
        ...
        // Act
        var serializer = RedisSerializerFactory.Create(SerializerType.SystemTextJson, options);
    ...
    public void SerializerFactory_Create_WithMessagePackOptions_PassesOptionsToSerializer()
    {
        ...
        // Act
        var serializer = RedisSerializerFactory.Create(SerializerType.MessagePack, options);
    ...
    public void SerializerFactory_Create_WithInvalidType_ThrowsArgumentOutOfRangeException()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            RedisSerializerFactory.Create((SerializerType)999));
    }
