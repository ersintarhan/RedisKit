...
namespace RedisLib.Tests
{
    public class SerializerTests
    {
        ...
        {
            // Act
            var serializer = RedisSerializerFactory.Create(RedisLib.Models.SerializerType.MessagePack, null);
        ...
        {
            // Act
            var serializer = RedisSerializerFactory.Create(RedisLib.Models.SerializerType.SystemTextJson, null);
        ...
        public void SerializerFactory_Create_WithJsonOptions_PassesOptionsToSerializer()
        {
            ...
            // Act
            var serializer = RedisSerializerFactory.Create(RedisLib.Models.SerializerType.SystemTextJson, options);
        ...
        public void SerializerFactory_Create_WithMessagePackOptions_PassesOptionsToSerializer()
        {
            ...
            // Act
            var serializer = RedisSerializerFactory.Create(RedisLib.Models.SerializerType.MessagePack, options);
        ...
        public void SerializerFactory_Create_WithInvalidType_ThrowsArgumentOutOfRangeException()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(() => 
                RedisSerializerFactory.Create((RedisLib.Models.SerializerType)999, null));
        }
